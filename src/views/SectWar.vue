...
.fighter.winner .fighter-name { color: #4caf50; font-weight: bold; }
...
.power-fill.left { background: linear-gradient(90deg, #2196f3, #42a5f5); }
...
.final-result.win { color: #4caf50; background: #4caf5011; border: 1px solid #4caf5033; }

...
function startSplash() {
  ...
  const pageComponents = {
    ...
    "wheel-game": defineAsyncComponent({ loader: () => import("./views/WheelGame.vue"), loadingComponent: { render() { return h(SkeletonLoader, { type: "grid" }) } }, delay: 0 }),
    "catch-game": defineAsyncComponent({ loader: () => import("./views/CatchGame.vue"), loadingComponent: { render() { return h(SkeletonLoader, { type: "grid" }) } }, delay: 0 }),

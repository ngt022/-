...
export const pillRecipes = [
  ...
  },
  {
    ...
    name: '五行丹',
    description: '融合五行之力的神奇焰丹，全面提升焰修者素质',
    grade: 'grade5',
    type: 'attribute',
    materials: [
  ...
  },
  {
    ...
    name: '天元丹',
    description: '凝聚天地精华的极品焰丹，大幅提升焰修速度',
    grade: 'grade6',
    type: 'cultivation',
    materials: [
  ...
  },
  {
    id: 'sun_moon_pill',
    name: '日月丹',
    description: '融合日月精华的焰丹，能大幅提升焰灵上限',
    grade: 'grade7',
    type: 'spirit',
    materials: [

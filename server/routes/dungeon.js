...
function buildPlayerCombatStats(gameData) {
  ...
  return {
    ...
    critRate: clamp01((combat.critRate || 0) + equipBonus.critRate + (petBonus.critRate || 0)),
    comboRate: clamp01((combat.comboRate || 0) + equipBonus.comboRate + (petBonus.comboRate || 0)),
    counterRate: clamp01((combat.counterRate || 0) + equipBonus.counterRate + (petBonus.counterRate || 0)),
    stunRate: clamp01((combat.stunRate || 0) + equipBonus.stunRate + (petBonus.stunRate || 0)),
    dodgeRate: clamp01((combat.dodgeRate || 0) + equipBonus.dodgeRate + (petBonus.dodgeRate || 0)),
    vampireRate: clamp01((combat.vampireRate || 0) + equipBonus.vampireRate + (petBonus.vampireRate || 0)),
    critResist: clamp01((resist.critResist || 0) + equipBonus.critResist + (petBonus.critResist || 0)),
    comboResist: clamp01((resist.comboResist || 0) + equipBonus.comboResist + (petBonus.comboResist || 0)),
    counterResist: clamp01((resist.counterResist || 0) + equipBonus.counterResist + (petBonus.counterResist || 0)),
    stunResist: clamp01((resist.stunResist || 0) + equipBonus.stunResist + (petBonus.stunResist || 0)),
    dodgeResist: clamp01((resist.dodgeResist || 0) + equipBonus.dodgeResist + (petBonus.dodgeResist || 0)),
    vampireResist: clamp01((resist.vampireResist || 0) + equipBonus.vampireResist + (petBonus.vampireResist || 0)),
    healBoost: clamp01((special.healBoost || 0) + equipBonus.healBoost + (petBonus.healBoost || 0)),
    critDamageBoost: (special.critDamageBoost || 0.5) + equipBonus.critDamageBoost + (petBonus.critDamageBoost || 0),
    critDamageReduce: clamp01((special.critDamageReduce || 0) + equipBonus.critDamageReduce + (petBonus.critDamageReduce || 0)),
    finalDamageBoost: clamp01((special.finalDamageBoost || 0) + equipBonus.finalDamageBoost + (petBonus.finalDamageBoost || 0)),
    finalDamageReduce: clamp01((special.finalDamageReduce || 0) + equipBonus.finalDamageReduce + (petBonus.finalDamageReduce || 0)),
    combatBoost: clamp01((special.combatBoost || 0) + equipBonus.combatBoost + (petBonus.combatBoost || 0)),
    resistanceBoost: clamp01((special.resistanceBoost || 0) + equipBonus.resistanceBoost + (petBonus.resistanceBoost || 0))
  }
}

...
const PILL_ITEMS = {
  ...
  cult_small:    { price:2000,  name:'小修为丹',   effect:'cultivation', multiplier:5, dailyLimit:5 },
  cult_medium:   { price:10000,  name:'中修为丹',   effect:'cultivation', multiplier:15, dailyLimit:3 },
  cult_large:    { price:50000, name:'大修为丹',   effect:'cultivation', multiplier:50, dailyLimit:1 },
  exp_1:  { price:500000,  name:'1级经验丹', effect:'levelup', levels:1, dailyLimit:3 },
  exp_5:  { price:2500000, name:'5级经验丹', effect:'levelup', levels:5, dailyLimit:1 },
  exp_10: { price:8000000, name:'10级经验丹',effect:'levelup', levels:10, dailyLimit:1 },
